...
class PolicySelectionPlanner(Planner):
    ...
    def update_nearest_pose_data(self, visibility_mask, current_pose, offset=0):
        ...
        for x, y in poses:
            ...
            if pose_data['index'] is None:
                pose_data['index'] = self.counter + offset
                pose_data['distance'] = distance
            elif pose_data['distance'] > distance:
                pose_data['index'] = self.counter + offset
                pose_data['distance'] = distance

    def get_costs(self, robot=None):
        ...
        self.navigation_data['net_motion'] = robot.net_motion
        ...
        for i, planner in enumerate(self.planners):
            ...
            if i == self.chosen_planner_idx:
                ...
                optimistic_lb, simply_connected_lb = self._get_lb_costs(planner)
