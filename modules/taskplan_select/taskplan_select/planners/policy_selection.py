from taskplan.planners.planner import Planner
from taskplan_select import offline_replay
import numpy as np
import taskplan
...
class PolicySelectionPlanner(Planner):
    ...
    def __init__(self, target_obj_info, planners, chosen_planner_idx, args, device=None, verbose=True):
        super(PolicySelectionPlanner, self).__init__(target_obj_info, args, device, verbose)
    ...
    def get_costs(self, robot):
        ...
        net_motion, _ = taskplan.core.compute_path_cost(self.grid, robot.all_poses)
