...
#     args.logfile_name = [
#         "task_learned_logfile.txt",
#         "task_pessimistic_greedy_logfile.txt",
#         "task_pessimistic_lsp_logfile.txt",
#     ][0]
...
#     nodes = [thor_data.scenegraph.nodes[i] for i in thor_data.scenegraph.container_indices + thor_data.scenegraph.room_indices]
#     cost_dict = taskplan.real_world_utils.utils.compute_distances(init_robot_pose, nodes)
#     # print(get_known_cost(grid, thor_data.containers, init_robot_pose))
#     # with open('/data/nodes.pkl', "wb") as f:

#     #     pickle.dump(nodes, f)

#     # with open('/data/cost_dict.pkl', "wb") as f:
...
#     pddl["problem"] = taskplan.pddl.helper.generate_pddl_problem_from_struct(pddl["problem_struct"])
