...
class DeliveryEnvironmentV2:
    ...
    def get_robot_pose(self):
        return [(50, 150), (350, 450)][0]  # Decide for left and right
...
def get_occupancy_grid():
    ...
    # Garbage can
    set_rectangle(grid, (260, 10), (280, 20), occupied)

    # wall1
    set_rectangle(grid, (0, 300), (410, 310), occupied)
    set_rectangle(grid, (490, 300), (600, 310), occupied)

    # wall2
    set_rectangle(grid, (300, 0), (310, 110), occupied)
    set_rectangle(grid, (300, 190), (310, 600), occupied)

    # bed
    set_rectangle(grid, (320, 320), (340, 350), occupied)

    # sofa
    set_rectangle(grid, (580, 370), (590, 390), occupied)

    # tvstand
    set_rectangle(grid, (320, 570), (350, 590), occupied)

    # desk
    set_rectangle(grid, (370, 570), (410, 590), occupied)
