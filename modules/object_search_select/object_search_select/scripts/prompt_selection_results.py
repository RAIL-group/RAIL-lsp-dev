...
if __name__ == "__main__":
    ...
    planner_names = ['OPTIMISTIC+MODEL',
                     'LLM+MODEL/P-CONTEXT-A/GPT-5', 'LLM+MODEL/P-CONTEXT-B/GPT-5', 'LLM+MODEL/P-MINIMAL/GPT-5',
    ...
    planner_plot_order = [1, 2, 3, 7, 4, 5, 6, 8, 0]
    ...
    for env in envs:
        ...
        with open(results_dir / f'planner_ranks_{env}.csv', 'w') as f:
            f.write(f"Seed,Best Cost,{ranks_str}\n")
