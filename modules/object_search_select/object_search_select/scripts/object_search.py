...
from object_search_select.planners import LSPLLMPlanner
from object_search_select.simulators import SceneGraphSimulator
...
def evaluate_main(args):
    ...
    # partial_map = object_search.core.PartialMap(known_graph, known_grid)
    ...
    naive_planning_loop = object_search.planners.planning_loop.PlanningLoop(
    ...
    naive_dist, naive_trajectory = object_search.core.compute_path_cost(known_grid, naive_path)
    ...
    learned_planning_loop = object_search.planners.PlanningLoop(
    ...
    learned_dist, learned_trajectory = object_search.core.compute_path_cost(known_grid, learned_path)
    with open(logfile, "a+") as f:
...
def make_combined_plot(args, known_graph, known_grid, robot_pose, target_obj_info,
    ...
    for idx, coords in enumerate(naive_path[1:]):
        ...
        # graph['node_coords']
        pose = object_search.utilities.utils. \
