...
def train_main(args):
    ...
    model = object_search.learning.models.fcnn.FCNN(args).to(device)
    ...
    preprocess_function = object_search.learning.models.fcnn.FCNN.preprocess_data
...
def get_parser():
    ...
    parser = argparse.ArgumentParser(
        description="Train FCNN with PyTorch.",
