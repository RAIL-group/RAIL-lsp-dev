...
state = State(robot_pos, graph, holdingObjects, fluents, True)
print(state.fluents)

print('___Robot drives near the sink___')
robot_pos = (110, 85)
new_state = State(robot_pos, graph, holdingObjects, fluents, False)
...
new_state = State(robot_pos, graph, holdingObjects, fluents, True)
print(new_state.fluents)
